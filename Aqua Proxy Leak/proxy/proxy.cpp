...
void setgtserver() {
    try
    {
        ...
        Client cli("https://meta.microu.sbs");
...
int main() {
    SetConsoleTitleA("AJProxy V2.3 | fixed & leaked -> ! vaccat#7777 <-");
...
/ __| '_ \| | '_ \ / _ \ | |/ _ \| |
\__ \ | | | | |_) |  __/_| | (_) | |
|___/_| |_|_|_.__/ \___(_)_|\___/|_|
              
AJProxy V2.3 | fixed & leaked -> ! vaccat#7777 <-
)" << '\n';
    try {
        char* pValue;
        size_t len;
